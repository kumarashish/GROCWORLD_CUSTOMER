...
public class MyCart extends Activity implements View.OnClickListener{
    ...
    public void callSmsApi() {
        ...
        Thread T2 = new Thread(new Runnable() {
            @Override
            public void run() {
                new WebApiCall(MyCart.this).getData(Common.getSendSMSUrl("8005300408", "You have received one new order,please check com.com.grocworld admin app for order details."));
   ...
   public void insertOrderItem(ProductModel items,String orderId)
   {
    ...
    public boolean isDeliveryAvailable(int pincode)
    {
        ...
        if((pincode==209601)||(pincode==209625))
        {
            status=true;
        }
        return status;
